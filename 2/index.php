    ...
    <div>
        <h1 id="top">
            <?php if (isLoggedIn() && $user): ?>
                Welcome, <?php echo htmlspecialchars($user['name']); ?>! Where traditions meets modern adventure!
            <?php else: ?>
                Welcome to Saudi!! Where traditions meets modern adventure!
            <?php endif; ?>
        </h1>
    </div>
    ...
    <section id="adventure">
        <div>
            ...
            <figure>
                ...
                <figcaption>
                    <h2>Bayada Park</h2>
                    Embark on an exciting mountain adventure in Al Bayda'a Park in Medina, one of the newest natural treasures in the Hijaz region. Discover remarkable geological formations and the diverse flora and fauna alongside a certified mountain guide, experiencing a journey that blends cultural richness with the beauty of nature in a breathtaking setting.
                </figcaption>
                <a href="https://www.google.com/maps/dir/?api=1&destination=24.461748,39.624043">
                    <h3><em>Get Directions!</em></h3>
                </a>
            </figure>
            <figure>
                <img src="img/qatt.png" alt="Al-Qatt Al-Aseeri" width="500" height="350">
                <figcaption>
                    <h2>Discover Al-Qatt Al-Aseeri Art</h2>
                    This vibrant female art tradition, inscribed on UNESCO's Intangible Cultural Heritage list in 2017, features geometric patterns and bright colors that have decorated Aseeri homes for generations. Created using natural pigments like gypsum, charcoal, and plant extracts, Al-Qatt was traditionally used to showcase a family's wealth and status.
                    <br>
                    <ul>Where to see it:
